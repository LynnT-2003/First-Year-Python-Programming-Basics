...
'''
## Update 0.1 (5th October) ##:
added 'course(s)' in print display in func5
updated order from A,A-,B+,B,B-,C+,C,C-,D,F to A,A-,B,B-,B+,C,C-,C+,D,F in func5
fixed print message error in func6

## Update 0.2 (7th October) ##
edited course code error in function 6
'''
