...
#finding and printing the sum and multiple of all the numbers the user input
for each in Ulist:
    total += each
...
#finding and printing the smallest and largest number in user list
...
print(f"The largeest number is {large}.")
