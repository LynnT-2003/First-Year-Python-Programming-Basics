#DO NOT TOUCH!
import ReadWriteModule2
data = ReadWriteModule2.readFile("academicrecords")
#DO NOT TOUCH!
...
def func1():
    ...
    ReadWriteModule2.write('newdata',data) #overwrite csv file
    print()
...
def func6():
    ...
    if match6 == True: #if there is a match
        ...
        print(f"Updated grade result {1}/{0} on {data[i][2]} as {new_grade}")
